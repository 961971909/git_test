...
// 写保护
#define PORT_EE_WP		 GPIOC
#define PIN_EE_WP   	 GPIO_Pin_8
...
#define PIN_DIN_STATUS2     GPIO_Pin_11
#define KEY_DIN_STATUS2     GPIO_ReadInputDataBit(PORT_DIN_STATUS2, PIN_DIN_STATUS2)

//========================================================================================
// LCD
#define PORT_LCD_BG         GPIOC
#define PIN_LCD_BG          GPIO_Pin_10
#define PORT_LCD_CS         GPIOD
#define PIN_LCD_CS          GPIO_Pin_2
#define PORT_LCD_WR         GPIOC
#define PIN_LCD_WR          GPIO_Pin_12
#define PORT_LCD_DATA       GPIOC
#define PIN_LCD_DATA        GPIO_Pin_11
...
#define LCD_SDA_L            GPIO_ResetBits(PORT_LCD_DATA , PIN_LCD_DATA)
    ...
    #define PORT_KEY_TWO     	GPIOC
    #define PIN_KEY_TWO         GPIO_Pin_2
    #define PORT_KEY_THREE     	GPIOC
    #define PIN_KEY_THREE       GPIO_Pin_1
    #define PORT_KEY_FOUR		GPIOC
    #define PIN_KEY_FOUR       	GPIO_Pin_0
    ...
    #define PIN_CTRL1       GPIO_Pin_6
    #define CTRL1_DisEnble  GPIO_SetBits(PORT_CTRL1, PIN_CTRL1)     // 1
    #define CTRL1_Enble     GPIO_ResetBits(PORT_CTRL1, PIN_CTRL1)

    #define PORT_CTRL2		GPIOC
    #define PIN_CTRL2       GPIO_Pin_7
    #define CTRL2_DisEnble  GPIO_SetBits(PORT_CTRL2, PIN_CTRL2)     // 2
    #define CTRL2_Enble     GPIO_ResetBits(PORT_CTRL2, PIN_CTRL2)
