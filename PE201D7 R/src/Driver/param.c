...
float RtuPrimaryDataHarmI[90];       //谐波电流
u16 RtuPrimaryDataTmpHarmI[180];      // 谐波电流串口发送数据 

const u16 Point_Num[4] = {1, 10, 100, 1000};
...
void InitCtrlParam(void)
{
    ...
    g_tParam.CtrlParam.PT_Point = 3;
    g_tParam.CtrlParam.CT_Point = 3;
    g_tParam.CtrlParam.PT1Num = 380;
    g_tParam.CtrlParam.PT2Num = 380;
    g_tParam.CtrlParam.CT1Num = 5;
    g_tParam.CtrlParam.CT2Num = 5;
...
#ifdef _GUILCD_
    g_tParam.CtrlParam.BlackTime = 600;
#else
