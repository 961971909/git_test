...
// 开关量框架1
const unsigned char LCD_COM_INS[] = {0x80,0x80,0x10,0x10};
const unsigned char LCD_PIN_INS[] = {86,84,86,84};

// 开关量框架2
const unsigned char LCD_COM_OUTS[] = {0X80,0X10};
const unsigned char LCD_PIN_OUTS[] = {82,82};

// 开关量状态1
const unsigned char LCD_COM_IN_On[] =   {0x40,0x40,0x80,0x80}; //闭合
const unsigned char LCD_COM_IN_Off[] =  {0x20,0x20,0x40,0x40}; //开断
const unsigned char LCD_PIN_IN_On[] =   {86,84,87,85};
const unsigned char LCD_PIN_IN_Off[] =  {86,84,87,85};

// 开关量状态2
const unsigned char LCD_COM_OUT_On[] =  {0X40,0X80};//闭合
const unsigned char LCD_COM_OUT_Off[] = {0X20,0X40};//开断
const unsigned char LCD_PIN_OUT_On[] =  {82,83};
const unsigned char LCD_PIN_OUT_Off[] = {82,83};
