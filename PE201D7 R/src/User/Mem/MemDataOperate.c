...
bool MemData_CmpParamType(PARAM_T *pSettingParam)
{
    ...
    if( pSettingParam->CtrlParam.PT1Num > MAX_PT || pSettingParam->CtrlParam.PT1Num < MIN_PT )
    {
        return FALSE;
    }
    if( pSettingParam->CtrlParam.PT_Point > MAX_Point || pSettingParam->CtrlParam.PT_Point < MIN_Point )
    {
        return FALSE;
    }
    if( pSettingParam->CtrlParam.PT2Num > MAX_PT || pSettingParam->CtrlParam.PT2Num < MIN_PT )
    {
        return FALSE;
    }
    if( pSettingParam->CtrlParam.CT1Num > MAX_CT || pSettingParam->CtrlParam.CT1Num < MIN_CT )
    {
        return FALSE;
    }
    if( pSettingParam->CtrlParam.CT_Point > MAX_Point || pSettingParam->CtrlParam.CT_Point < MIN_Point )
    {
        return FALSE;
    }
    if( pSettingParam->CtrlParam.CT2Num > MAX_CT || pSettingParam->CtrlParam.CT2Num < MIN_CT )
    {
        return FALSE;
    }
